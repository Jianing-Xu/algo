...
/**
 * 排序算法集合 包含各种经典排序算法的实现
 */
public class SortingAlgorithms {

  /**
   * 冒泡排序 时间复杂度：O(n²)，空间复杂度：O(1) 稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  /**
   * 选择排序 时间复杂度：O(n²)，空间复杂度：O(1) 不稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  /**
   * 插入排序 时间复杂度：O(n²)，空间复杂度：O(1) 稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  /**
   * 归并排序 时间复杂度：O(n log n)，空间复杂度：O(n) 稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  /**
   * 快速排序 平均时间复杂度：O(n log n)，最坏时间复杂度：O(n²) 空间复杂度：O(log n)，不稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  /**
   * 堆排序 时间复杂度：O(n log n)，空间复杂度：O(1) 不稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  /**
   * 计数排序 时间复杂度：O(n + k)，空间复杂度：O(k) 稳定排序算法，适用于范围较小的整数排序
   *
   * @param arr      待排序数组
  ...
  /**
   * 基数排序 时间复杂度：O(d * (n + k))，空间复杂度：O(n + k) 稳定排序算法
   *
   * @param arr 待排序数组
   */
  ...
  public static void main(String[] args) {
    ...
    testSortingPerformance("计数排序", () -> countingSort(original.clone(), maxValue),
        original.clone());
