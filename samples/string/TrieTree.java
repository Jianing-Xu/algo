...
/**
 * Trie树（前缀树）实现 支持a-z这26个英文字母的字符集
 */
public class TrieTree {
  ...
  /**
   * 插入单词到Trie树中 时间复杂度：O(m)，其中m是单词长度
   *
  ...
  /**
   * 查找单词是否存在于Trie树中 时间复杂度：O(m)，其中m是单词长度
   *
   * @param word 要查找的单词
  ...
  /**
   * 查找是否存在以给定前缀开头的单词 时间复杂度：O(m)，其中m是前缀长度
   *
   * @param prefix 前缀
