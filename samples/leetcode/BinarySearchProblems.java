...
/**
 * LeetCode二分查找相关问题解答 包含x的平方根等经典二分查找题目
 */
public class BinarySearchProblems {
  ...
  /**
   * LeetCode 69. x 的平方根 给你一个非负整数 x ，计算并返回 x 的算术平方根 由于返回类型是整数，结果只保留整数部分，小数部分将被舍去
   * <p>
   * 解题思路：二分查找 1. 在 [0, x] 范围内查找平方根 2. 对于每个中点 mid，检查 mid * mid 与 x 的关系 3. 找到最大的整数，使得其平方不超过 x
   * <p>
  ...
  /**
   * 平方根的牛顿迭代法 时间复杂度：O(log x) 空间复杂度：O(1)
   *
   * @param x 输入的非负整数
   * @return x的算术平方根（整数部分）
   */
  ...
  /**
   * 平方根的位运算解法 时间复杂度：O(log x) 空间复杂度：O(1)
   *
   * @param x 输入的非负整数
   * @return x的算术平方根（整数部分）
   */
  ...
  /**
   * 判断一个数是否为完全平方数 LeetCode 367. 有效的完全平方数
   *
   * @param num 输入数字
   * @return 是否为完全平方数
   */
  ...
  /**
   * 寻找旋转排序数组中的最小值 LeetCode 153. 寻找旋转排序数组中的最小值
   *
   * @param nums 旋转排序数组
   * @return 最小值
   */
  ...
  /**
   * 在旋转排序数组中搜索 LeetCode 33. 搜索旋转排序数组
   *
   * @param nums   旋转排序数组
   * @param target 目标值
