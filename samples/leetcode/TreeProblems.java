...
/**
 * LeetCode二叉树相关问题解答 包含二叉树的前序遍历等经典二叉树题目
 */
public class TreeProblems {

  /**
   * LeetCode 144. 二叉树的前序遍历 给你二叉树的根节点 root ，返回它节点值的前序遍历
   * <p>
   * 解题思路：递归 前序遍历：根 -> 左 -> 右
   * <p>
  ...
  /**
   * 二叉树的前序遍历（迭代实现） 时间复杂度：O(n) 空间复杂度：O(n) - 栈空间
   *
   * @param root 根节点
   * @return 前序遍历结果
   */
  ...
  /**
   * 二叉树的前序遍历（Morris遍历） 时间复杂度：O(n) 空间复杂度：O(1)
   *
   * @param root 根节点
   * @return 前序遍历结果
   */
  ...
  private static TreeNode generateRandomTreeHelper(int maxDepth, double probability, Random random,
      int value) {
