...
public class QueueProblems {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("k等于数组长度: " + Arrays.toString(maxSlidingWindow(new int[]{1, 2, 3}, 3)));
        ...
        System.out.println("清空后状态: size=" + largeDeque.size() + ", isEmpty=" + largeDeque.isEmpty());
