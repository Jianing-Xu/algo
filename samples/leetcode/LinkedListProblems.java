...
public class LinkedListProblems {
     ...
     * 2. 递归地合并，直到只剩一个链表
     * 
     * 时间复杂度：O(N log k)，其中N是所有链表节点总数，k是链表个数
    ...
    public static void main(String[] args) {
        ...
        System.out.println("哈希表检测: " + hasCycleHash1 + ", 耗时: " + (cycleHashTime1 / 1000.0) + "μs");
